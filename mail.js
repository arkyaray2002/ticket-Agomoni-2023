...
async function generateAndSendEmail(jsonData) {
    ...
    const mailOptions = {
        ...
        <h3 style="color: yellow; font-weight: bold;">* This ticket is for one-time use only. Kindly show this ticket at the time of food distribution.</h3>
        <h3 style="color: pink; font-weight: bold;">* One Food Packet will be alloted for one person only with this ticket. Kindly do not share this ticket with anyone.</h3>
        <img src="cid:imageId" />
        </center>
        </body>
        `,
